...
class RctContent extends React.Component {
	...
	*/
	componentWillMount() {
		console.log( "RctContent.componentWillMount()" );
	}
	componentDidMount() {
		console.log( "RctContent.componentDidMount()" );
	}
	...
	*/
	componentWillReceiveProps() {
		console.log( "RctContent.componentWillReceiveProps()" );
	}
	// Use shouldComponentUpdate() to let React know if a component’s output is not affected by the current change in state or props. The default behavior is to re-render on every state change, and in the vast majority of cases you should rely on the default behavior.
	// shouldComponentUpdate() is invoked before rendering when new props or state are being received. Defaults to true. This method is not called for the initial render or when forceUpdate() is used.
	/*shouldComponentUpdate() {
		console.log( "RctContent.shouldComponentReceiveProps()" );
	}*/
	componentWillUpdate() {
		console.log( "RctContent.componentWillUpdate()" );
	}
	componentDidUpdate() {
		console.log( "RctContent.componentDidUpdate()" );
	}
	// Unmounting: This method is called when a component is being removed from the DOM:
	componentWillUnmount() {
		console.log( "RctContent.componentWillUnmount()" );
	}
	...
	componentDidCatch() {
		console.log( "RctContent.componentDidCatch()" );
	}
    ...
    return (
      ...
      /*<div className="RctContent" onClick={( event ) => this.handleOnClick( event )}>
